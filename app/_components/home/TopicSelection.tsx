...
export function TopicSelection({news}: {news: News[]}): ReactElement {
    ...
    const text: string[] = [
        "Subscribe to the newsletter. An email is sent to those who have an active newsletter subscription at the time of publication. A subscription can always be discontinued when desired.",
        ...
        "Connect with other retro enthusiasts. When signed in, you can scan through existing profiles and interact with people. Create an account and make your own profile today!"
    ]
