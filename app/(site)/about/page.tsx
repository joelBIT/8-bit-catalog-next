...
const TIMELINE_TITLE = [
    { year: 1983, title: "Famicom gets released" },
    { year: 1985, title: "Repackaging of the Famicom" },
    { year: 1986, title: "Nationwide release in United States" },
    { year: 1987, title: "Released in Europe" },
    { year: 1990, title: "Market decline" },
    { year: 1995, title: "Discontinuation" },
    { year: 1997, title: "Emulation" },
