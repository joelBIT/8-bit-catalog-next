...
import * as schema from "@/app/_db/schema/articles";
...
export const databaseClient = drizzle(client, {schema});      // Used for communication with the database (containing metadata)
