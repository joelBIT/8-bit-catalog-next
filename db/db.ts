...
export async function getImageLink(cover: string) {
    // const { data } = await databaseClient.storage.from('covers').getPublicUrl(cover);
    // return data.publicUrl;
    return "https://tnkcekyijuynctkddkwy.supabase.co/storage/v1/object/public/covers/10%20Yard%20Fight.webp";
}